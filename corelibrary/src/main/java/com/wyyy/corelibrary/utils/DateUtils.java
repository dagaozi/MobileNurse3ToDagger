...
public class DateUtils {
    ...
    public static String formatDate(String str, String oldFormat, String newFormat) {
        ...
        SimpleDateFormat newSDF = new SimpleDateFormat(StringUtils.getStr(newFormat,"yyyy-MM-dd"));
        String sfstr = "";
        try {
     ...
     * @return
     */
    public static boolean isStartMoreDateEndDate(String start, String end) {
        // 设定时间的模板
